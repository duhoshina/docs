  ...
  <Tab title="Componente Direto">
    ...
    export function CTAButton() {
      useEffect(() => {
        ...
        const script = document.createElement('script');
        script.src = `https://testly.com.br/flow.js?experimentId=${experimentId}&elementId=${elementId}&apiKey=${apiKey}&debug=true`;
        script.async = true;
        document.body.appendChild(script);
...
<AccordionGroup>
  ...
  <Accordion title="Conversões não registram" icon="hand-pointer">
...
<CardGroup cols={3}>
  <Card title="Email" icon="envelope" href="mailto:support@testly.com">
    [support@testly.com.br](mailto:support@testly.com.br)
  </Card>
